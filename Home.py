...
with col_left:
    ...
    lessons = [
        ...
        },
        {
            ...
            "desc": "Run over-representation analysis (ORA) and GSEA-like ranked enrichment using built-in educational toy pathways. Understand what ORA and GSEA measure and how to interpret enrichment plots.",
        ...
        },
        {
            ...
            "desc": "Explore real GEO public study records, learn how to choose the right files for re-analysis, work through a reproducibility checklist, and understand the differences between web app, local, and HPC analysis.",
            "page": "pages/10_Public_Data.py",
            "available": True,
        },
        {
            "icon": "🔬",
            "title": "Lesson 11 — Single-Cell RNA-seq (Introductory Module)",
            "desc": "Conceptual introduction to scRNA-seq: how it differs from bulk RNA-seq, what clustering and UMAP reveal, and what tools are needed for real single-cell analysis. Includes a simulated UMAP visualisation.",
            "page": "pages/11_Single_Cell_RNAseq.py",
            "available": True,
        },
    ]
...
- Required column: **groupA** (defines comparison groups)
- Optional but important: **donor** (paired DE), **batch** (batch correction)
- Optional descriptive: **sex**, **age**, other annotations
...
⚠️ Sample names must match exactly between files (case-sensitive).  
⚠️ Duplicate gene IDs, missing metadata columns, or non-numeric counts will be rejected with a clear error message.  
⚠️ Very large files (>5,000 genes × 200+ samples) may be slow in this web app — consider local analysis for large datasets.
        """)
...
""")
    ...
    st.page_link("pages/08_Clustering_Heatmaps.py",           label="🗺️ Lesson 8 — Clustering & Heatmaps",    icon="▶")
    ...
    st.page_link("pages/11_Single_Cell_RNAseq.py",            label="🔬 Lesson 11 — Single-Cell RNA-seq",     icon="▶")
